...
public class PutBookingTest {
    ...
    void updateBookingUsingValidDataTest() {
        ...
        BookingdatesDataObject updateBookingdatesDataObject = new BookingdatesDataObject();
        BookingDataObject updateBooking = new BookingDataObject();

        updateBookingdatesDataObject.setCheckin(updatedCheckin);
        updateBookingdatesDataObject.setCheckout(updatedCheckout);
        ...
        updateBooking.setBookingdatesDataObject(updateBookingdatesDataObject);
